    ...
    >
      <div>
        ...
        <p className='text-center text-2xl max-md:text-lg font-semibold max-w-3xl mx-auto mb-6'>
          Built as part of the Bellcorp Event Management Application Program, to
          handle dynamic data fetching, user authentication, and state
          management efficiently, providing a seamless "Event Discovery
          Experience".
        </p>
        ...
        <p className='text-center text-lg font-medium mb-4 dark:text-yellow-300'>
          ...
          <a
            ...
            className='underline hover:text-indigo-700 dark:hover:text-yellow-300'
          >
            bellcorpevent@gmail.com
          </a>
        </p>
        ...
        <div className='text-center text-lg font-semibold dark:text-gray-400'>
          &copy; {new Date().getFullYear()} Bellcorp India. All rights reserved.
        </div>
      </div>
    </footer>
  )

...
describe('Welcome Page', () => {
  test('renders event summary with name, title, date, and location', () => {
    ...
    expect(getAllByTextContent(summary, '2026-02-01')).toHaveLength(3)
    expect(getAllByTextContent(summary, 'Hyderabad')).toHaveLength(3)
  })
  ...
  test('calendar invite button triggers download', () => {
    ...
    const calendarButton = screen.getByRole('button', {
      name: /Download calendar invite/i,
    })

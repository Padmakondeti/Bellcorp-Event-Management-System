    ...
    getEvents()
      .then(res => {
        ...
        const total = res.data.reduce(
          (sum, ev) => sum + (ev.totalSeats || 0),
          0,
        )
        const totalLeft = res.data.reduce(
          (sum, ev) => sum + (ev.leftSeats || 0),
          0,
        )
        setTotalSeats(total)
    ...
    >
      ...
      >
        <article className='bg-white dark:bg-gray-800 p-4 rounded shadow'>
          <h3 className='text-lg font-semibold text-indigo-700 dark:text-yellow-300'>
            📅 Total Events
          </h3>
          <hr />
        ...
        {events.length === 0 ? (
          ...
          <div className='overflow-x-auto'>
            ...
            >
              ...
              >
                <tr role='row'>
                  <th role='columnheader' className='border p-2'>
                    S.No.
                  </th>
                  <th role='columnheader' className='border p-2'>
                    Event ID
              ...
              <tbody role='rowgroup'>
                {events.map((event, index) => (
                  ...
                  >
                    <td role='cell' className='border p-2'>
                      {index + 1}
                    </td>
                    <td
                      role='cell'
                      className='border p-2 text-indigo-700 dark:text-yellow-300'
                    >
                      <button
                    ...
                    >
                      <button
                        onClick={() =>
                          navigate(`/admin/registrants/event/${event._id}`)
                        }
                    ...
                    <td
                      role='cell'
                      className='border p-2 flex flex-wrap gap-2 justify-center'
                    >
                      <button
                        onClick={() =>

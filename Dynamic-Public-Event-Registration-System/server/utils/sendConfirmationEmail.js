  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        ${
          message
            ? `<p style="font-size:15px;">Additional note you shared with us: <em>${message}</em><br>Thanks for that!</p>`
            : ''
        }
        <p style="margin-top:20px;">
          🔎 If you have questions before the event, check our 
          <a href="https://bellcorp-event-registration-system.onrender.com/#faq" style="color:#007bff;">Frequently Asked Questions</a>.
        </p>
        <p style="font-size:15px;">Learn more or get updates via:</p>
        <ul style="font-size:15px;">
          <li>🌐 Website: <a href="https://bellcorp-event-registration-system.onrender.com/" style="color:#007bff;">Visit Platform</a></li>
          <li>🔗 LinkedIn: <a href="https://www.linkedin.com/company/bellcorp-india/" style="color:#007bff;">Bellcorp India</a></li>
